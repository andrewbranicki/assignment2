...
for SIGMA = 1:20
    ...
    % CHANGE SIGMA EACH FOR LOOP
    sigma_in = SIGMA*1e-2;    % inside boxes
...
figure(10)
plot(1:20,CURRENT)
title('Effect of Sigma on Current')
xlabel('Number that Sigma (0.01) is Multiplied by')
